...
public record MatchInfoDto(Integer matchId, String description, TeamDto team1, TeamDto team2, String target1Code, String target2Code, Boolean isKnockOut, Status status, List<Set> sets) {
}
