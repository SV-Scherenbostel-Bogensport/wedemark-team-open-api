...
public interface TeamRepository extends JpaRepository<Team, Integer> {
    ...
    @Query("SELECT new dev.laubfrosch.bogensport.wedemarkteamopenapi.api.dto.AttendeesDto(t.teamId, t.name, t.playerCount, t.lookingForTeammates, t.hasPayed) FROM Team t")
